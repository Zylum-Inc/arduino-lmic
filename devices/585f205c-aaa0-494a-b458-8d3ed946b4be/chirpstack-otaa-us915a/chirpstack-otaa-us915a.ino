...
static const u1_t PROGMEM APPEUI[8]= { 0x83, 0x79, 0xAB, 0xD5, 0xED, 0x72, 0x44, 0x98 };
void os_getArtEui (u1_t* buf) { memcpy_P(buf, APPEUI, 8);}

// chirpstack: 01 C4 1A 5E E5 38 C7 98
// chirpstack: E5 9E B5 7D FD E1 A8 46
// This should also be in little endian format, see above.
static const u1_t PROGMEM DEVEUI[8]= { 0x83, 0x79, 0xAB, 0xD5, 0xED, 0x72, 0x44, 0x98 };
void os_getDevEui (u1_t* buf) { memcpy_P(buf, DEVEUI, 8);}

// This key should be in big endian format (or, since it is not really a
// number but a block of memory, endianness does not really apply). In
// practice, a key taken from the TTN console can be copied as-is.
// chirpstack: AB B0 0F 59 55 A5 30 5D C5 0E 03 B7 86 4E 7C FA
// chirpstack: 65 73 F5 EC 7A 9E 40 39 D9 75 79 2A 52 93 E2 AE
...
static const u1_t PROGMEM APPKEY[16] = { 0xFD, 0xE6, 0x8C, 0xB1, 0x37, 0x47, 0x0C, 0x7B, 0xEA, 0x21, 0x17, 0x13, 0x6A, 0x83, 0x8D, 0xD2 };
...
void setup() {
    ...
    // spectrum.
    bit_t result = LMIC_selectSubBand(1);
